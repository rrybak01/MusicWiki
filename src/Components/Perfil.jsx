                    ...
                    <Container>
                        <Row>
                            <Col xs={6} className="p-3 m-auto  shadow rounded">
                                <h1>Hola {this.state.Usuario.name}, disfruta de tu sesión</h1>
                                <div>
                                    <div className='divUsuario'>Usuario: {this.state.Usuario.user}</div>
                                    <div className='divNombre'>Nombre: {this.state.Usuario.name}</div>
                                    <div className='divEmail'>Email: {this.state.Usuario.email}</div>
                                </div>
                            </Col>
                        </Row>
                    </Container>
